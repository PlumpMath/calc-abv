...
var G__23531 = o;
(G__23531[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__23539 = jsprops;
(G__23539["defaultValue"] = value);

(G__23539["onChange"] = ((function (G__23539,v,value,on_change){
return (function (p1__23537_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__23537_SHARP_);
});})(G__23539,v,value,on_change))
);
...
var vec__23546 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23546,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23546,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23546,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___23551 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___23551 == null)){
} else {
var key_23552 = temp__4661__auto___23551;
(jsprops["key"] = key_23552);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23554 = (new reagent.impl.template.NativeWrapper());
(G__23554["name"] = c);
...
var G__23556 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__23556) : reagent.impl.template.as_element.call(null,G__23556));
} else {
...
var len__7322__auto___23562 = arguments.length;
var i__7323__auto___23563 = (0);
while(true){
if((i__7323__auto___23563 < len__7322__auto___23562)){
args__7329__auto__.push((arguments[i__7323__auto___23563]));

var G__23564 = (i__7323__auto___23563 + (1));
i__7323__auto___23563 = G__23564;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23560){
var G__23561 = cljs.core.first(seq23560);
var seq23560__$1 = cljs.core.next(seq23560);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23561,seq23560__$1);
});
...
break;
default:
var G__23568 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__23568;
continue;
...
var n__7162__auto___23571 = a.length;
var i_23572 = (0);
while(true){
if((i_23572 < n__7162__auto___23571)){
(a[i_23572] = reagent.impl.template.as_element((a[i_23572])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7162__auto___23574 = a.length;
var i_23575 = (0);
while(true){
if((i_23575 < n__7162__auto___23574)){
var val_23576 = (a[i_23575]);
if((cljs.core.vector_QMARK_(val_23576)) && ((reagent.impl.template.key_from_vec(val_23576) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23575] = reagent.impl.template.as_element(val_23576));

var G__23577 = (i_23575 + (1));
i_23575 = G__23577;
continue;
} else {
}
...
var ctx = {};
var vec__23581 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23581,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23581,(1),null);
...
var G__23585 = (cljs.core.count(argv) - first_child);
switch (G__23585) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__23585){
