...
if((i < len)){
var k = (ks[i]);
var G__23446 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__23447 = (i + (1));
m = G__23446;
i = G__23447;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__23451 = c;
var G__23451__$1 = (((G__23451 == null))?null:G__23451.prototype);
if((G__23451__$1 == null)){
return null;
} else {
return (G__23451__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__23455 = c;
var G__23455__$1 = (((G__23455 == null))?null:G__23455.prototype);
if((G__23455__$1 == null)){
return null;
} else {
return (G__23455__$1["render"]);
}
})()));
});
...
var G__23459 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__23459) : reagent.impl.component.as_element.call(null,G__23459));
};
...
var _STAR_current_component_STAR_23466 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_23466;
}});
...
var G__23474 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__23474) {
...
return ((function (G__23474){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__23477 = reagent.impl.component.state_atom(c);
var G__23478 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__23477,G__23478) : cljs.core.reset_BANG_.call(null,G__23477,G__23478));
});
;})(G__23474))
...
reagent.ratom.dispose_BANG_(G__23480_23482);
}
...
var renders_23485 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_23486 = cljs.core.first(cljs.core.vals(renders_23485));
if((cljs.core.count(renders_23485) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_23485))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_23486)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_23486], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var elem = (function (){var G__23495 = (function (){var or__6247__auto__ = (function (){var G__23497 = c;
if((G__23497 == null)){
return null;
} else {
...
var G__23499__$2 = (((G__23499__$1 == null))?null:reagent$impl$component$component_path(G__23499__$1));
...
return reagent.impl.util.fun_name(G__23501__$1);
}
}
})();
